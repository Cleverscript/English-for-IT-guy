...
| **placeholders** | шаблоны, заполнители | | 
| **skipped** | пропущен | | 
...
| **entered** | вошел | | 
| **state** | состояние | | 
| **fail** | сбой, не успешный, не удалось, провал | | 
...
> **end of live** - конец жизни
> 
> **entered failed state** - вошёл в состояние сбоя
> 
> **just du it** - просто делай это
> 
